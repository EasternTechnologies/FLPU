        ...
        @if(isset($articles))
            @foreach($articles as $item)
                <div class="search_block">
                    <a href="/report/{{ $item->reports->types->slug }}/article/{{$item->id}}@if(isset($patterns)){{"?patterns=$patterns_tourl&replacements=$replacements_tourl"}} @endif" target="_blank" class="title_link text_decor">
                        <?php echo
