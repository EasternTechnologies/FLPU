            ...
            <div class="col_calc_270 pl30 posr">
                ...
                @if(isset($article->title))
                    @if($article->reports->types->slug == 'plannedexhibition')
                        <div class="article_title">
                            <?php echo strip_tags($article->title, "<p><a><h1><h2><h3><h4><h5><h6><b>");
                            ?>
                        </div>
                    @else
                ...
                @if($article->reports->types->slug == 'plannedexhibition')
                    <p><strong>Отчет: </strong>
                        <span class="italic_14"><a class="text_decor" href="/report/{{ $article->reports->types->slug }}/show/{{ $article->report_id }}">{{ $article->reports->types->title }}</a></span>
                    </p>
                ...
                @else
                    ...
                    <p><strong>Отчет: </strong>
                        <span class="italic_14"><a class="text_decor" href="/report/{{ $article->reports->types->slug }}/show/{{ $article->report_id }}">@if($article->reports->types->slug == 'various'){{ $article->reports->title }}@else{{ $article->reports->types->title }}@endif</a></span>
                    </p>
